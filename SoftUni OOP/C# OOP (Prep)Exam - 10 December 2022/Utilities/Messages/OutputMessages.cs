namespace ChristmasPastryShop.Utilities.Messages
{
    ...
    {
        public const string NewBoothAdded = "Added booths number {0} with capacity {1} in the pastry shop!";
        ...
        public const string NoAvailableBooth = "No available booths for {0} people!";
        ...
        public const string BoothNotFound = "Could not find booths number {0}!";
